  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#070707] px-5 text-white landing-grid">
      <div className="max-w-md text-center">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan-600 shadow-glow"><Orbit size={28} /></div>
        <div className="mt-7 text-xs font-bold uppercase tracking-[0.25em] text-cyan-400">Erro 404</div>
